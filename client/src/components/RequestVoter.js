...
class RequestVoter extends Component {
  ...
  addVoter = async () => {
    await this.state.VotingInstance.methods.requestVoter(this.state.name, this.state.aadhar, this.state.constituency).send({from : this.state.account , gas: 1000000});
    // Reload
